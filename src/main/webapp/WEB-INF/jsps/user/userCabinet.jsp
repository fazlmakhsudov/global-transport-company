    			...
    			<div class="row">
                    <div class='col col-2 text-left'>
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                          <a class="nav-link ${profiletab}" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><h5>Profile</h5></a>
                          <a class="nav-link ${requeststab}" id="v-pills-requests-tab" data-toggle="pill" href="#v-pills-requests" role="tab" aria-controls="v-pills-requests" aria-selected="false"><h5>Requests</h5></a>
                          <a class="nav-link ${invoicestab}" id="v-pills-invoices-tab" data-toggle="pill" href="#v-pills-invoices" role="tab" aria-controls="v-pills-invoices" aria-selected="false"><h5>Invoices</h5></a>

                          <a class="nav-link ${deliveriestab}" id="v-pills-deliveries-tab" data-toggle="pill" href="#v-pills-deliveries" role="tab" aria-controls="v-pills-deliveries" aria-selected="false"><h5>Deliveries</h5></a>

                        </div>
                    </div>
                    <div class='col col-10'>
                        <div class="tab-content" id="v-pills-tabContent">
                          <div class="tab-pane fade ${profiletabbody}" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <%@ include file="/WEB-INF/jspf/user/profile.jspf"%>
                          </div>
                          <div class="tab-pane fade ${requeststabbody}" id="v-pills-requests" role="tabpanel" aria-labelledby="v-pills-requests-tab">
                            <c:if test = "${requestsNumber > 0}">
                             <%@ include file="/WEB-INF/jspf/user/requests.jspf"%>
                            </c:if>
                          </div>
                          <div class="tab-pane fade ${invoicestabbody}" id="v-pills-invoices" role="tabpanel" aria-labelledby="v-pills-invoices-tab">
                            <c:if test = "${invoicesNumber > 0}">
                                <%@ include file="/WEB-INF/jspf/user/invoices.jspf"%>
                            </c:if>
                          </div>
                          <div class="tab-pane fade ${deliveriestabbody}" id="v-pills-invoices" role="tabpanel" aria-labelledby="v-pills-invoices-tab">
